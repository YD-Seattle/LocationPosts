...
if ( ! class_exists( 'YD_Plugin_Skeleton' ) ) {
	 ...
	 *
	 * YD_Plugin_Skeleton is an object-oriented/MVC base for building WordPress plugins
	 */
	class YD_Plugin_Skeleton extends YD_Module {
		...
		public function upgrade( $db_version = 0 ) {
			if ( version_compare( $this->modules['YD_Settings']->settings['db-version'], self::VERSION, '==' ) ) {
				return;
			}

			foreach ( $this->modules as $module ) {
				$module->upgrade( $this->modules['YD_Settings']->settings['db-version'] );
			}

			$this->modules['YD_Settings']->settings = array( 'db-version' => self::VERSION );
