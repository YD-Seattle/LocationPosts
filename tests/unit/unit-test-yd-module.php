...
require_once( dirname( dirname( __DIR__ ) ) . '/classes/yd-module.php' );

/**
 * Unit tests for the YD_Module class
 * Uses the SimpleTest For WordPress plugin
 *
 * @link http://wordpress.org/extend/plugins/simpletest-for-wordpress/
 */
if ( ! class_exists( 'UnitTestYD_Module' ) ) {
	class UnitTestYD_Module extends UnitTestCase {
		/*
		 * get_instance()
		 */
		public function test_get_instance() {
			// Two instances of the same module
			$first_instance = YDChildClass::get_instance();
			$first_instance->init();
			$first_instance->foo = 'first';

			$second_instance = YDChildClass::get_instance();
			...
			$separate_module = YDAnotherChildClass::get_instance();
		...
		public function test_magic_get() {
			$child = YDChildClass::get_instance();
	...
	} // end UnitTestYD_Module
}

// Mock up a child class
if ( ! class_exists( 'YDChildClass' ) ) {
	class YDChildClass extends YD_Module {
...
// Mock up a child class
if ( ! class_exists( 'YDAnotherChildClass' ) ) {
	class YDAnotherChildClass extends YD_Module {
