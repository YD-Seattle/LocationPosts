 ...
 */
if ( ! class_exists( 'YDTestSuite' ) ) {
	class YDTestSuite extends TestSuite {
		function __construct() {
			parent::__construct();

			$this->addFile( dirname( __FILE__ ) . '/unit/unit-test-yd-module.php' );
			$this->addFile( dirname( __FILE__ ) . '/unit/unit-test-yd-settings.php' );
			$this->addFile( dirname( __FILE__ ) . '/unit/unit-test-yd-instance-class.php' );
		}
